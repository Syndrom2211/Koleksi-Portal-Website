...
var adi_bottom_leftCSS='#adi_bottom_left{position:fixed;';
adi_bottom_leftCSS=adi_bottom_leftCSS+'_position:absolute;';
adi_bottom_leftCSS=adi_bottom_leftCSS+'bottom:0px;';
adi_bottom_leftCSS=adi_bottom_leftCSS+'left:0px;';
adi_bottom_leftCSS=adi_bottom_leftCSS+'clip: inherit;';
adi_bottom_leftCSS=adi_bottom_leftCSS+cot_t1_DOCtp;
...
document.write('<style type="text/css">'+adi_bottom_leftCSS+cot_tl_popCSS+'</style>');
...
function cot(cot_tl_theLogo,cot_tl_LogoType,LogoPosition,theAffiliate)
{
   ...
   document.write('<div id="adi_bottom_left">');
